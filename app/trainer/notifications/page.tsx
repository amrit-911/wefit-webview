    ...
    <div className="min-h-screen bg-[#121212] font-sans pt-12 px-5 pb-28">
      ...
      {!loading && notifications.length === 0 && (
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <p className="text-[14px] font-bold text-white mb-1">No notifications yet</p>
          <p className="text-[12px] text-gray-500">Activity from your clients will appear here</p>
        </div>
      )}
              ...
              <motion.button
                ...
                className={`w-full flex items-center gap-4 p-4 rounded-2xl border transition-colors text-left ${
                  notif.read
                    ...
                    : "bg-[#1c1c1e] border-white/5 hover:bg-[#242424]"
                }`}
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {notif.body && (
                    <p className="text-[11px] text-gray-500 font-medium mt-0.5 truncate">{notif.body}</p>
                  )}
                ...
                {!notif.read && (
                  <div className="w-2 h-2 rounded-full bg-[#a3e635] shrink-0" />
                )}
              </motion.button>
            ))}
          </AnimatePresence>
